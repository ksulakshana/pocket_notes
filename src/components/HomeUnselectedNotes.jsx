...
import styles from './HomeUnselectedNotes.module.css';
import homeImage from '../assets/Home_Notes_Image.png';

function HomeUnselectedNotes() {
  return (
    <div className={styles.container}>
        <div className={styles.subcontainer}>
            <div className={styles.imgBox}>
                <img src={homeImage} alt="Pocket Notes"/>
            </div>
                <span className={styles.heading}>Pocket Notes</span>
            <div>
                <p className={styles.description}>Send and receive messages without keeping your phone online.<br/>
                Use Pocket Notes on up to 4 linked devices and 1 mobile phone</p>
            </div>
        </div>
        <div className={styles.footerdiv}>
            <p className={styles.footer}>
                <svg width="13" height="13" viewBox="0 0 17 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default HomeUnselectedNotes
